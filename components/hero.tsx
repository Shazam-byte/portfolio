...
import { ArrowRight, Github, Linkedin, X, Instagram } from "lucide-react"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            <h1 className="text-4xl md:text-6xl font-bold mb-4">
              Hi, I'm <span className="text-primary">Shahzaman Ajmal</span>
            </h1>
            ...
            <div className="flex gap-4 mt-8">
              <Button variant="ghost" size="icon" className="rounded-full" asChild>
                <a href="https://www.linkedin.com/in/shahzaman-ajmal" target="_blank" rel="noopener noreferrer">
